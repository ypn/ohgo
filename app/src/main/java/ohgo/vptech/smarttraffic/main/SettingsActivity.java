...
/*import ohgo.vptech.smarttraffic.main.reporter.BackgroundService;*/
...
public class SettingsActivity extends PreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("list_languages"));
        }
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            if(key.equals("list_languages")){
                ...
                Utilities.setLocale(listLanguage.getValue(),getActivity());
